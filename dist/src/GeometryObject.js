...
export class GeometryObject {
    ...
    setPropertyParam(param) {
        ...
        if (this.properties[param.name] == undefined)
            throw new Error("Object: " + this.name + "doesn't have property: " + param.name);
        if (param.value == undefined)
            throw new Error("Param value is undefined");
    ...
    setOnClick(fnc) {
        if (!(typeof fnc === "function"))
            throw new Error("Incorrect input, must be a function!");
...
//# sourceMappingURL=GeometryObject.js.map